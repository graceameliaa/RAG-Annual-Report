...
Here is your text formatted in GitHub Flavored Markdown (GFM), with inline code for keywords, fenced code blocks for shell commands, and task lists, as you requested.
